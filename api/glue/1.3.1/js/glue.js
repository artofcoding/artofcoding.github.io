...
GLUE = {
    ...
    loadScripts: function(scripts, idx, callback) {
        ...
        if (idx < scripts.length) {
            //DEBUG console.log("GLUE.loadScripts: idx="+idx);
    ...
    init: function(callback) {
        ...
        this.loadScript(this.META.GLUE_URL + "/glue.fastms.js");
        this.loadScript(this.META.GLUE_URL + "/glue.ui.js", function() { GLUE.UI.init(myCallback); });
    },
